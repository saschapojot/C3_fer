...
dipole_abs_valsAll=np.array(dipole_abs_valsAll)

dipole_abs_br=dipole_abs_valsAll-interval_lowerValsAll

fig,ax=plt.subplots()
ax.errorbar(TToPlt,dipole_abs_valsAll[TInds],yerr=dipole_abs_br[TInds],fmt='o',color="black", ecolor='r', capsize=5,label='mc')
